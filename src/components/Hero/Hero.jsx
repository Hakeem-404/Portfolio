  ...
  return (
    <section className={styles.container} >
        <div className={styles.content}>
            ...
            I'm a computing graduate passionate about AI, software development, and cloud systems currently based in London. My technical expertise spans across frontend (React, Vue, JavaScript, HTML/CSS), backend (Node.js, Java, SQL), and mobile development (Android, Xamarin). 
